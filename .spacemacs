...
values."
  (setq-default
   ...
   dotspacemacs-install-packages 'used-only)) (defun dotspacemacs/init () "Initialization function.
...
values."
  ...
  (setq-default
   ...
   ;;   :size-limit-kb 1000)
   ;; (default nil)
   dotspacemacs-line-numbers `(:relative nil :size-limit-kb 1000)
...
you should place your code here."
  ...
  (defun kill-current-buffer ()
    ...
    (kill-buffer))
  ;; Configure spaceline
  (setq ns-use-srgb-colorspace nila)
